                        ...
                        <div class="col-xl-2 col-sm-6 mb-4" >
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-center text-uppercase mb-1">
                                            <a class="text-success" href="courses.php"><img src="img/online-learning (1).png" width="100" alt="">
                                        </div>
                                        <div class="h5 mb-0 font-weight-bold text-center text-gray-900">
                                            Courses</a>
                        ...
                        <div class="col-xl-2 col-sm-6 mb-4" >
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-center text-uppercase mb-1">
                                            <a class="text-success" href="bank-details.php"><img src="img/debit-card.png" width="100" alt="">
                                        </div>
                                        <div class="h5 mb-0 font-weight-bold text-center text-gray-900">
                                            Bank Details</a>
                                        </div>
