                ...
                <div class="container-fluid">
					...
					<section>
						<div class="container-fluid my-5">
							<h1 class="text-center text-gray-900 font-weight-bold">Welcome to <span style="color: #5e2c04;">CSTA</span> Portal</h1>
							<h4 class="text-center text-gray-900">You are currently logged in as guest</h4>
							<h3 class="mt-3" style="font-weight: 900; color: #000;">Menu</h3>
							<div class="row mt-3">
