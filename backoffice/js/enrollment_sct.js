$(document).ready(function() {
    var enrollTable = $('#enrollTable_sct').dataTable({
        dom: 'Bfrtip',
        ...
        "info": true,
        "ajax": {
            url: "codes/fetch_enrollment_sct.php",
            type: "POST"
    ...
    $(document).on('submit', '#enrollForm_sct', function(event) {
