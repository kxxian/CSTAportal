                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <form id="login-form" action="codes/reset-password.php" method="post" role="form" style="display: block;">
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="pwd" id="pwd" tabindex="1" class="form-control" placeholder="Enter new password" value="" required="">
                                            </div>

                                            <div class="form-group">
                                                
                                                <input type="password" name="pwd-repeat" id="pwd-repeat" tabindex="1" class="form-control" placeholder="Repeat new password" value="" required="">
                                            </div>
                                            <div class="form-group">
                                                <div class="row">

                                                    <div class="col-sm-12">
                                                        <input type="submit" name="reset-password-submit" id="login-submit" tabindex="4" class="form-control btn btn-login" value="reset password">
