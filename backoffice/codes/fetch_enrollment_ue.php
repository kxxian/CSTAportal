...
$query = '';
$output = array();
$query .= "SELECT * from vwguest_enrollment_unitearner ";
...
if (isset($_POST["search"]["value"])) {
    ...
    $query .= 'OR ndp LIKE "%' . $_POST["search"]["value"] . '%")';
...
foreach ($result as $row) {
    ...
    $sub_array[] = '<a target="_blank" title="Birth / Marriage Certificate" class="btn btn-success btn-sm" href="../student/uploads/requirements/ue/bc/'.$row['ge_id'].'.pdf">
    <i class="fa fa-fw fa-receipt"></i>
    </a>
    
    <a target="_blank" title="Transcript of Records" class="btn btn-warning btn-sm" href="../student/uploads/requirements/ue/tor/'.$row['ge_id'].'.pdf">
...
$output = array(
    ...
    "recordsFiltered"   => get_enrollments_ue(),
    "data"              => $data
