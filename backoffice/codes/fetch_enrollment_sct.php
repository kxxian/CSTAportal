...
$query = '';
$output = array();
$query .= "SELECT * from vwguest_enrollment_sct ";
...
foreach ($result as $row) {
    ...
    $sub_array[] = '<a target="_blank" title="Birth / Marriage Certificate" class="btn btn-success btn-sm" href="../student/uploads/requirements/sct/bc/'.$row['ge_id'].'.pdf">
    <i class="fa fa-fw fa-receipt"></i>
    </a>
    
    <a target="_blank" title="Transcript of Records" class="btn btn-warning btn-sm" href="../student/uploads/requirements/sct/tor/'.$row['ge_id'].'.pdf">
...
$output = array(
    ...
    "recordsFiltered"   => get_enrollments_sct(),
    "data"              => $data
