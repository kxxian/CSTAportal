                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900"><i class="fas fa-user-graduate fa-fw"></i> Courses
                                <button type="button" id="addUser" data-toggle="modal" data-target="#usersModal" class="btn btn-success  float-right">Add Course</button>
                            </h6>
    ...
    <div class="modal-dialog modal-lg">
        <form method="POST" id="usersForm" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <label for="mname" class="text-gray-900 font-weight-bold">Course Description</label>
            ...
            event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode)==32" name="mname" id="mname" class="form-control" placeholder="Middle Name..">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            <label for="lname" class="text-gray-900 font-weight-bold">Abbreviation</label>
                            <input type="text" onkeypress="return (event.charCode > 64 && 
                        ...
                        <div class="col-sm-6">
                            <label for="gender" class="text-gray-900 font-weight-bold">Department</label>
