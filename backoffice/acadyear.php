                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <button type="button" id="addSem" data-toggle="modal" data-target="#syModal" class="btn btn-success  float-right">Add School Year</button>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <button type="button" id="addUser" data-toggle="modal" data-target="#semModal" class="btn btn-success  float-right">Add Semester</button>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" onkeypress="return (event.charCode > 64 && 
	                                event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode)==32" name="lname" id="lname" class="form-control" placeholder="School Year">
                        </div>
