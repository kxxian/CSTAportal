                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900"><i class="fas fa-folder fa-fw"></i> Documents Requests
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="reqdocuTable" class="table table-bordered" width="100%" cellspacing="0">
