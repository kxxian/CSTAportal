<?php 
    ...
    if (isset($_POST['firstName'])) {
        ...
        $sql = "INSERT INTO guest_register_tesda (guest_first_name, guest_last_name, guest_middle_name, guest_suffix, guest_address, guest_email, guest_mobile, guest_telephone, guest_course, guest_guardian, guest_guardian_no, guest_guardian_email) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
