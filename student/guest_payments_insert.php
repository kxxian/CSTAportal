                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <a href="guest_payments.php">
                            <button class="btn btn-primary" title="Go back to bank details">Go Back</button>
                        </a>
                    </div>
                                ...
                                <div class="col-md-12">
                                    <form id="myForm">
                                        <div class="card shadow">
                                            ...
                                            <div class="card-body">
                                                <p style="font-style: italic;"><b>NOTE:</b> Please use the same email address you used to register.</p>
                                                <div class="row">
                                                    <div class="col-md-5">
                                                    ...
                                                    <div class="col-md-4 mt-3">
                                                        <label for="totalAmount">Total Ammount:</label>
                                                        <input type="text" id="" name="totalAmount" class="form-control" placeholder="e.g 3000 (Minimum)" required>
                                                    </div>
                                                    <div class="col-md-4 mt-3">
