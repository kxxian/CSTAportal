...
$query = '';
$output = array();
$query .= "SELECT * from vwguest_enrollment_ce ";
...
if (isset($_POST["search"]["value"])) {
    ...
    $query .= 'OR sub_to_enroll LIKE "%' . $_POST["search"]["value"] . '%")';
...
foreach ($result as $row) {
    ...
    $sub_array[] = $row["sub_to_enroll"];
    $sub_array[] = $row["previous_deg"];
	
 
    $sub_array[] = '<a target="_blank" title="Birth / Marriage Certificate" class="btn btn-success btn-sm" href="../student/uploads/requirements/ce/bc/'.$row['ge_id'].'.pdf">
    <i class="fa fa-fw fa-receipt"></i>
    </a>
    
    <a target="_blank" title="Permit to Cross Enroll" class="btn btn-warning btn-sm" href="../student/uploads/requirements/ce/permit/'.$row['ge_id'].'.pdf">
...
$output = array(
    ...
    "recordsFiltered"   => get_enrollments_ce(),
    "data"              => $data
