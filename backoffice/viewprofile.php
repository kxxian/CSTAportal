...
if (isset($_GET['stud'])){
    ...
    $sql = "SELECT * from vwforenrollment_students where sid=? and enrollment_status=? ";
    $data = array($sid,"Validating Requirements");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-4 text-gray-900 font-weight-bold"><?=$fullname?>'s Profile</h1>
                    <div class="main-body">
                                                ...
                                                <div class="d-flex flex-column align-items-center text-center">
                                                        ...
                                                        <div class="picture-container">
                                                            <div class="picture">
                                                                ...
                                                                <?php
                                                                $file = '../student/uploads/users/' . $sid . '.jpg';
                                                                if (!file_exists($file)) {
                                                                    $dp = 'default.jpg';
                                                                } else {
                                                                    $dp = $sid . '.jpg';
                                                                }
                                                                echo '<img  src="../student/uploads/users/' . $dp . '" class="picture-src" id="wizardPicturePreview" width="150" title="Choose Picture">' ?>
                        ...
                        <tbody>
                            ...
                            while ($row = $stmt->fetch()) {
                                ...
                                echo '<tr> 
                                        ...
                                        <a target="_blank" href="../student/uploads/requirements/' . $row['filename'] . '" ><button" class="userinfo btn btn-info btn-sm" title="View">
