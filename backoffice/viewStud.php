...
if(isset($_GET['id'])){
  ...
  $address=$rowSelect['completeaddress'];
  $guardian=$rowSelect['guardian'];
  $guardianNum=$rowSelect['guardiancontact'];
  $stmtLoad=null;
}   
    // $userid=$_POST['userid'];
...
<div class="col-lg-8 mx-auto p-3 py-md-5">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
      ...
      <span class="fs-4">View Student Information</span>
    </a>
  </header>
  ...
  <main>  
    <?php
      echo '<div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Student Number: '.$studnum.'</h5>
                <p class="card-text">Name: '.$fname." ".$mname." ".$lname.'</p>
                <p class="card-text">Gender: '.$gender.'</p>
                <p class="card-text">Date of Birth: '.$bday.'</p>
                <p class="card-text">Mobile: '.$mobile.'</p>
                <p class="card-text">Email: '.$email.'</p>
                <p class="card-text">Address: '.$address.'</p>
                <p class="card-text">Guardian: '.$guardian.'</p>
                <p class="card-text">Guardian Number: '.$guardianNum.'</p>
              </div>
          </div>';
    ?>
  </main>
