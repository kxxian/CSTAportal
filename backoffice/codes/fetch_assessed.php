...
$query .= "AND enrollment_status='Waiting Payment' AND schoolyr='$currentsyval' AND semester='$currentsemval' ";
...
if (isset($_POST["order"])) {
    ...
    $query.='ORDER BY enrollment_ID desc ';
}
if($_POST["length"] != -1){
...
foreach ($result as $row) {
    ...
    class="btn btn-success btn-sm sendassessment" title="Resend Assessment Form"><i class="fa fa-fw fa-redo"></i></button>
    </center>
    ';
