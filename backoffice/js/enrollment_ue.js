$(document).ready(function() {
    var enrollTable = $('#enrollTable_ue').dataTable({
        dom: 'Bfrtip',
        ...
        "info": true,
        "ajax": {
            url: "codes/fetch_enrollment_ue.php",
            type: "POST"
    ...
    $(document).on('submit', '#enrollForm_ue', function(event) {
