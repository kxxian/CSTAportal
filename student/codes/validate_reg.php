...
if (isset($_POST['validate'])) {
    ...
    if ($stmt->rowCount() > 0) {
        echo "<span style='color: #df4759; font-weight:bold'>A user matched your registration. Forgot your password? Click <a href='login.php'>here</a></span>";
...
if (isset($_POST['validate2'])) {
    ...
    if ($stmt3->rowCount() > 0) {
        ...
        <span class='float-right' style='color: #df4759; font-weight:bold; text-align:right'>Email address already registered</span>
...
if (isset($_POST['validate3'])) {
    ...
    if ($stmt3->rowCount() > 0) {
        echo "<span style='color: #df4759; font-weight:bold'>Student number is already in use. <a href='login.php'> Forgot Password?</a></span>";
        echo "<script>$('#submit').prop('disabled', true);</script>";
    } else {
        echo "<script>$('#submit').prop('disabled', false);</script>";
    }
