...
<head>
    ...
    <title>Pending Payments | Guest</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900"><i class="fas fa-money-bill fa-fw"></i> Pending Payments Guest
...
<script src="js/pending-payments_guest.js"></script>
</div>
