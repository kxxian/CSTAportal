...
<head>
    ...
    <title>Enrollment | Cross Enrollee</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900"><i class="fas fa-edit fa-fw"></i> Cross Enrollee 
                        ...
                        <div class="card-body">
							<ul class="nav nav-tabs mb-3">
								<li class="nav-item dropdown">
									...
									<li><a class="dropdown-item" href="enrollment_guest.php">Freshmen</a></li>
                            ...
                            <div class="table-responsive">
                                <table id="enrollTable_guest_cross_enrollee" class="table table-bordered text-gray-900" width="100%" cellspacing="0">
...
<div id="enrollModal_guest_cross_enrollee" class="modal fade">
    <div class="modal-dialog modal-md">
        <form method="POST" id="enrollForm_guest_cross_enrollee" enctype="multipart/form-data">
...
<script src="js/enrollment_ce.js"></script>
</div>
