...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-4 text-gray-900"><?=$fullname?>'s Profile</h1>
          ...
          <div class="row gutters-sm">
                ...
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                      <h6 class="m-0 font-weight-bold text-gray-900"><i class="fa-solid fa-file-circle-check"></i><i class="fas fa-file-alt"></i> Requirements Uploaded</h6>
                  </div>
                        <?php
                            ...
                            if ($count==0){
                                ...
                                echo '<h6 class="text-center" style="font-weight:bold; color:red;">No Files Uploaded Yet</h6>';
                            }else {
