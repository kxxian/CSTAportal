...
<head>
    ...
    <title>Enrollment | Unit Earner</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900"><i class="fas fa-edit fa-fw"></i> Unit Earner
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="enrollTable_ue" class="table table-bordered text-gray-900" width="100%" cellspacing="0">
...
<div id="enrollModal_ue" class="modal fade">
    <div class="modal-dialog modal-md">
        <form method="POST" id="enrollForm_ue" enctype="multipart/form-data">
...
<script src="js/enrollment_ue.js"></script>
</div>
